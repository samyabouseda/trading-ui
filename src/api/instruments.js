...
const getAll = async () => {
	try {
		...
		// 			{
		// 				name: 'Apple Inc.',
		// 				id: '5e4538ef7d4c990824c4d470',
		// 				symbol: 'AAPL',
		// 				address:
		// 					'0x776a9b10c5fe1805317B4B0da110672C53608aDd',
		// 			},
		// 			{
		// 				name: 'Microsoft Corp.',
		// 				id: '5e4538ef7d4c990824c4d472',
		// 				symbol: 'MSFT',
		// 				address:
		// 					'0x776a9b10c5fe1805317B4B0da110672C53608aAF',
		// 			},
		// 			{
		// 				name: 'Tesla Inc.',
		// 				id: '5e4538ef7d4c990824c4d488',
		// 				symbol: 'TSLA',
		// 				address:
		// 					'0x776a9b10c5fe1805317B4B0da110672C53608aCD',
		// 			},
		// 		],
		// 	},
		// }
...
const depositFiat = async ({ amount, privateKey }) => {
	try {
		const URL = `${SERVICE_URL}/deposit/USDX`
		return await axios.post(URL, {
			amount,
			privateKey,
		})
